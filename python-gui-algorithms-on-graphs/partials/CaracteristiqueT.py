...
import numpy as np
import partials.GraphT as  GraphT 
...
class Ui_Charac(object):
    ...
    def setupUi(self, MainWindow, matrix,nodesNumber, graphType,startNode):
        ...
        self.label_0_0.setStyleSheet("background-image: url(C:/Users/mohhd/Desktop/Images/image_2.png); background-color: #D1CFFF;")
...
if __name__ == "__main__":
    ...
    MainWindow.setFixedSize(845, 581)
    ui = Ui_Charac()
    MainWindow.show()
    sys.exit(app.exec_())
